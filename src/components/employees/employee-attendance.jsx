...
<<<<<<< HEAD
  const handleInputChange = (employeeId, employeeName,salaryType, employeeData, field, value) => {
=======
...
>>>>>>> 78e71b4e9e1252a71ba42dc22fed382409b67333
    ...
    if (index === -1) {
      setAttendanceData(prevData => [
        ...prevData,
<<<<<<< HEAD
        { employeeId, employeeName, salaryType,...employeeData, [field]: value }
=======
    ...
    if (isGroupMatch && isProjectMatch && isSalaryTypeMatch) {
      return (
        <tr key={employee._id}>
          ...
          {salaryType === 'hourly' && (
            <>
              <td><input type="time" onChange={(e) => handleInputChange(employee.empID, employee.empName, employee.salaryType,{ normalRate: employee.normalRate, overRate: employee.overRate }, 'normalStartTime', e.target.value)} /></td>
              <td><input type="time" onChange={(e) => handleInputChange(employee.empID, employee.empName,employee.salaryType, { normalRate: employee.normalRate, overRate: employee.overRate }, 'normalEndTime', e.target.value)} /></td>
              <td><input type="time" onChange={(e) => handleInputChange(employee.empID, employee.empName,employee.salaryType, { normalRate: employee.normalRate, overRate: employee.overRate }, 'overtimeStartTime', e.target.value)} /></td>
              <td><input type="time" onChange={(e) => handleInputChange(employee.empID, employee.empName, employee.salaryType,{ normalRate: employee.normalRate, overRate: employee.overRate }, 'overtimeEndTime', e.target.value)} /></td>
            </>
          )}
          <td>
            <div>
              <label>
                <input
                  ...
                  value="P"
                  onChange={(e) => handleInputChange(employee.empID, employee.empName, employee.salaryType,{ monthlySalary: employee.monthlySalary }, 'attendanceStatus', e.target.value)}
                />
                Present
              </label>
              <label>
